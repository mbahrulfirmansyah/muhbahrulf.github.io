...
# Membuat dan menampilkan GUI
    ...
    def tampilan_gui(self):
        ...
        Label(self, text="Kelompok").grid(row=2, column=0, padx=10, pady=10)
    ...
    # Menambahkan Treeview
        ...
        self.tree.heading("NIS", text="Kode Guru")
        self.tree.heading("Nama", text="Nama")
        self.tree.heading("Jurusan", text="Kelompok")
        self.tree.heading("Alamat", text="Mapel")
